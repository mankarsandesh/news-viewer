...
<template>
  <div
    class="bg-white overflow-hidden border-b-4 border-blue-500 w-full h-full"
  >
    <div class="p-4 md:p-6">
      ...
      <!-- <p class="mb-3" lang="xml"> 
        {{ description }}
      </p> -->
  
          <a :href="link" target="_blank" class="text-blue-300 pt-3"  >Read More</a>
      ...
      <div class="text-xs flex items-center mt-4">
        ...
        <p class="leading-none">{{ pubDate }}</p>
      </div>
    </div>
  </div>
</template>
